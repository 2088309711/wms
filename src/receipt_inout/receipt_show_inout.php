...
?>
    ...
    <form id="item_in" name="item_in" method="post" action="receipt_in_bg.php" onsubmit=" return checkForm()">
        ...
        <fieldset>
            ...
            <p>&nbsp;</p>
            <label>录单日期</label>
            <input name="date" id="date" type="text" value="<?php echo $date; ?>" style="background-color:#CCCCCC"
                   readonly/>
            <label>存货仓库</label>
            ...
            <p>&nbsp;</p>
            <label>业务员</label>
            <input id="yewuyuan" name="yewuyuan" type="text" value="<?php echo $yewuyuan; ?>"
        ...
        <fieldset>
            <legend>货品列表</legend>
            <table id="item_list" border="1" width="100%" cellspacing="0" cellpadding="5"
