...
<div style="margin-bottom:8px; height:20px"> 精确查询：
    ...
    <input name="search" type="button" value="查找"
           onclick="location.href='../receipt_inout/receipt_show_inout.php?id=' + document.getElementById('receipt_id').value"/>
</div>
<!--精确查询框架-->
<!--查询框架-->
<div style="margin-bottom:8px; height:20px">
    ...
    <!--货品ID-->
    <div id="inquiry_item">
        <input id="item_id" name="item_id" value="请输入货品ID" type="text" onclick="this.value=''"
               onblur="if(this.value=='') this.value='请输入货品ID'"/>
    ...
    <div id="inquiry_receipt">
        <input id="receipt_id" name="item_id" value="请输入单据ID" type="text" onclick="this.value=''"
               onblur="if(this.value=='') this.value='请输入单据ID'"/>
        <input name="button" type="button" value="查询"
