...
CREATE TABLE `exchange` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=33 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='库存调拨';
...
CREATE TABLE `exchange_data` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='调拨明细';
...
CREATE TABLE `take_check` (
  ...
  `update_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=13122301 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='库存盘点';
