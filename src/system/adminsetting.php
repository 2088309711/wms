...
<form name="form" method="post" action="saveadmin.php?flag=0" onSubmit="return chkinput(this)">
    <table width="1104" border="0" cellpadding="0" cellspacing="0" bgcolor="#DEEBEF">
        <tr>
            <td height="255" colspan="2" rowspan="4" align="center" valign="middle" scope="col"><select name="left"
                                                                                                        size="20"
                                                                                                        multiple
                                                                                                        style="width:100px;"
                                                                                                        onchange="javascript:window.open('adminsetting.php?name='+ this.value, '_self');">
                    <?php
        ...
        <input name="adminname" type="text" value="<?php echo $info['name']; ?>" class="big_td"/>
                    ...
                    <a href="addadmin.php" target="_self"><img src="../images/adduser.jpg" alt="添加用户" width="30"
                                                               height="30" border="3"/></a>添加新用户 <br/>
                </label></td>
        </tr>
        <tr>
            <td height="5" align="left" valign="top" scope="col"><img src="../images/line.gif" width="600" height="4"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td height="158" align="left" valign="top" scope="col">
                <table width="600" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[0] == 1){ ?>checked="checked" <?php } ?>/>
                                往来单位管理</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[1] == 1){ ?>checked="checked" <?php } ?>/>
                                部门设置</label>
                        </td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[2] == 1){ ?>checked="checked" <?php } ?>/>
                                员工管理</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[3] == 1){ ?>checked="checked" <?php } ?>/>
                                仓库设置</label></td>
                    </tr>
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[4] == 1){ ?>checked="checked" <?php } ?>/>
                                出入库分类</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[5] == 1){ ?>checked="checked" <?php } ?>/>
                                货品分类管理</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[6] == 1){ ?>checked="checked" <?php } ?>/>
                                货品信息管理</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[7] == 1){ ?>checked="checked" <?php } ?> />
                                计量单位管理</label></td>
                    </tr>
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[8] == 1){ ?>checked="checked" <?php } ?>/>
                                入库管理</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[9] == 1){ ?>checked="checked" <?php } ?>/>
                                出库管理</label>
                        </td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[10] == 1){ ?>checked="checked" <?php } ?>/>
                                库存调拨</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[11] == 1){ ?>checked="checked" <?php } ?>/>
                                库存盘点</label></td>
                    </tr>
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[12] == 1){ ?>checked="checked" <?php } ?>/>
                                库存查询</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[13] == 1){ ?>checked="checked" <?php } ?>/>
                                库存预警</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[14] == 1){ ?>checked="checked" <?php } ?>/>
                                入库统计</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[15] == 1){ ?>checked="checked" <?php } ?>/>
                                出库统计</label></td>
                    </tr>
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[16] == 1){ ?>checked="checked" <?php } ?>/>
                                调拨统计</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[17] == 1){ ?>checked="checked" <?php } ?>/>
                                盘点统计</label>
                        </td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[18] == 1){ ?>checked="checked" <?php } ?>/>
                                操作用户设置</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[19] == 1){ ?>checked="checked" <?php } ?>/>
                                数据备份</label></td>
                    </tr>
                    <tr>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[20] == 1){ ?>checked="checked" <?php } ?>/>
                                数据恢复</label></td>
                        <td><label>
                                <input name="auth[]" type="checkbox" class="big_td" value="<?php echo $i++; ?>"
                                       <?php if ($auth[21] == 1){ ?>checked="checked" <?php } ?>/>
                                查看系统操作日志</label></td>
                        <td>&nbsp;</td>
                        <td>&nbsp;</td>
                    </tr>
        ...
        <tr>
            <td height="34" colspan="3" align="center" valign="middle">
                ...
                <input name="button" type="button"
                       onclick="javascript:window.open('adminsetting.php?name=<?php echo $name; ?>', '_self')"
                       value="取消"/></td>
        </tr>
        <tr>
