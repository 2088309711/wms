...
<div align="right" style="width:200px;float:right">排序方式：
    <select name="orderby" onchange="location.href=this.value">
        <option value="company_show.php?orderby=id" <?php if ($orderby == "" || $orderby == "id") echo " selected='selected' "; ?>>
            编号
        </option>
        <option value="company_show.php?orderby=name" <?php if ($orderby == "name") echo " selected='selected' "; ?>>
            名称
        </option>
        <option value="company_show.php?orderby=type" <?php if ($orderby == "type") echo " selected='selected' "; ?>>
            类型
        </option>
        <option value="company_show.php?orderby=area" <?php if ($orderby == "area") echo " selected='selected' "; ?>>
            区域
        </option>
        <option value="company_show.php?orderby=contact" <?php if ($orderby == "contact") echo " selected='selected' "; ?>>
            联系人
        </option>
    </select>
</div>
