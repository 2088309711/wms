<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\php-workspace\wms/tp5/application/user\view\basics\warehouse.html";i:1582552166;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1582601906;s:62:"D:\php-workspace\wms\tp5\application\user\view\nav_basics.html";i:1581870660;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-card-body">
            ...
            <table class="layui-table" lay-data="{ toolbar: '#toolbarDemo', url:'#', page: true, limit: 6, limits:[6]}">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'principal',align:'center'}">负责人</th>
                    <th lay-data="{field:'phone_principal',align:'center'}">负责人电话</th>
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <a href="/add_warehouse" class="layui-btn layui-btn-sm">添加仓库</a>
    </div>
</script>
