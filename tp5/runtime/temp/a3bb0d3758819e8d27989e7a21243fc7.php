<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"D:\php-workspace\wms/tp5/application/user\view\repertory\inventory_allocation_details.html";i:1582220845;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1581872702;s:65:"D:\php-workspace\wms\tp5\application\user\view\nav_Repertory.html";i:1582220019;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    ...
    <div class="layui-card" style="margin: 15px 0;">
        <div class="layui-card-header">库存调拨记录</div>
        <div class="layui-card-body">
            ...
            <table class="layui-table" lay-data="{ toolbar: '#toolbarDemo', url:'#', page: true, limit: 6, limits:[6]}">
                ...
                <tr>
                    ...
                    <th lay-data="{field:'warehouse_from',align:'center'}">出货仓库</th>
                    <th lay-data="{field:'warehouse_to',align:'center'}">入货仓库</th>
                    <th lay-data="{field:'create_time',align:'center'}">调拨时间</th>
...
<script type="text/html" id="toolbarDemo">
    <div class="layui-btn-container">
        <a href="/add_staff" class="layui-btn layui-btn-sm">库存调拨</a>
