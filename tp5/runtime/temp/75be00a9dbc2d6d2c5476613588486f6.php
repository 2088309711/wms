<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"D:\php-workspace\wms/tp5/application/user\view\system\operational_user_management.html";i:1581685685;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1582548581;s:62:"D:\php-workspace\wms\tp5\application\user\view\nav_system.html";i:1581743400;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div id="main-nav" data-switch="1" class="layui-side layui-bg-black">
        <div class="layui-side-scroll">
            <ul id="nav" class="layui-nav layui-nav-tree" lay-filter="test">
                <li class="layui-nav-item"><a href="/operational_user_management">操作用户管理</a></li>
<li class="layui-nav-item"><a href="/update_password">修改密码</a></li>
<li class="layui-nav-item"><a href="/data_backup">数据备份</a></li>
<li class="layui-nav-item"><a href="/reduction_of_data">数据还原</a></li>
<li class="layui-nav-item"><a href="/operating_log">系统登录日志</a></li>
