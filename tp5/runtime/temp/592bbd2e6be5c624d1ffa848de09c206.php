<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\php-workspace\wms/tp5/application/user\view\basics\add_company.html";i:1582623781;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1582601906;s:62:"D:\php-workspace\wms\tp5\application\user\view\nav_basics.html";i:1581870660;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-fluid">
    ...
    <div class="layui-card" style="margin: 15px 0;">
        <div class="layui-card-header">添加往来单位</div>
            ...
            <form class="layui-form" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            ...
                            <input type="radio" name="type" value="0" title="经销商" checked>
                            <input type="radio" name="type" value="1" title="供应商">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="tariff" autocomplete="off" class="layui-input">
                        </div>
                    </div>
