<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:73:"D:\php-workspace\wms/tp5/application/user\view\basics\add_categories.html";i:1582623409;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1582601906;s:62:"D:\php-workspace\wms\tp5\application\user\view\nav_basics.html";i:1581870660;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <form class="layui-form" method="post">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="radio" name="type" value="0" title="出库" checked>
                            <input type="radio" name="type" value="1" title="入库">
                        </div>
                    </div>

                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 130px;">库存成本核算</label>
                        <div class="layui-input-inline">
                            <input type="checkbox" name="cost" value="1" lay-skin="switch" lay-text="参与|不参与" checked>
                        </div>
                    </div>
