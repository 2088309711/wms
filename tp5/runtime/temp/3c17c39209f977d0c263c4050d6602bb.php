<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"D:\php-workspace\wms/tp5/application/user\view\storeroom\out_storage_3.html";i:1582520100;s:56:"D:\php-workspace\wms\tp5\application\user\view\base.html";i:1581872702;s:65:"D:\php-workspace\wms\tp5\application\user\view\nav_storeroom.html";i:1582519346;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    layui.use(['form', 'table', 'jquery'], function () {
        ...
        table.on('edit(test)', function (obj) { //注：edit是固定事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            $.get('/out_storage/ajax/' + obj.data.id + '/' + obj.field + '/' + obj.value, function (data) {
                if (data.code == 0) {
                    layer.msg(data.msg)
                }
            });
